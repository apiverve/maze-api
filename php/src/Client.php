 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/maze?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/maze';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MazeClient] {$message}\n";
        }
    }
}

...
const (
	baseURL        = "https://api.apiverve.com/v1/maze"
	defaultTimeout = 30 * time.Second
)

// Client is the Maze Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Maze Generator API client.
...
// Execute makes a request to the Maze Generator API with typed parameters.
//

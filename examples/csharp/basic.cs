/*
 * Maze Generator API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Maze Generator API.
 * API Documentation: https://docs.apiverve.com/ref/maze
 */
    ...
    class MazeGeneratorExample
    {
        ...
        static async Task<JsonDocument> CallMazeGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;width&quot;] &#x3D; 15, [&quot;height&quot;] &#x3D; 15, [&quot;difficulty&quot;] &#x3D; &quot;medium&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Maze Generator API...\n");

            var result = await CallMazeGeneratorAPI();

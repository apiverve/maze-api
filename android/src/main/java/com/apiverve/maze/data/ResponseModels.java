...
//
//     MazeGeneratorData data = Converter.fromJsonString(jsonString);

package com.apiverve.maze.data;
...
public class Converter {
    ...
    public static MazeGeneratorData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(MazeGeneratorData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(MazeGeneratorData.class);
        writer = mapper.writerFor(MazeGeneratorData.class);
    }
...
// MazeGeneratorData.java

package com.apiverve.maze.data;

import com.fasterxml.jackson.annotation.*;

public class MazeGeneratorData {
    private long width;
    private long height;
    ...
    @JsonProperty("grid")
    public long[][] getGrid() { return grid; }
    @JsonProperty("grid")
    public void setGrid(long[][] value) { this.grid = value; }

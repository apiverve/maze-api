...
```gradle
dependencies {
    implementation 'com.github.apiverve:maze-api:1.1.14'
}
```
...
```java
import com.apiverve.maze.MazeGeneratorAPIClient;
import com.apiverve.maze.APIResponse;
import com.apiverve.maze.APIException;

// Initialize the client
MazeGeneratorAPIClient client = new MazeGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("width", 15);
    parameters.put("height", 15);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/maze](https://docs.apiverve.com/ref/maze)
...
- **Documentation:** [https://docs.apiverve.com/ref/maze](https://docs.apiverve.com/ref/maze)
- **Issues:** [GitHub Issues](https://github.com/apiverve/maze-api/issues)
